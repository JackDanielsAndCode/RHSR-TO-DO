...
var config      = require('../config.json') || {redisUrl: process.env.REDIS_URL, dbNumber:process.env.DB_NUMBER}; //set up config and use your redis url or your local redis with this url "redis://localhost:6379", second part for heroku
